...
static SG_EemStates EemStates;
static boolean MachineTimeReducedOnce;
static uint32 compteurStepTis100ms = 0;
static RhoTrigs rhoTrigs;
static DhoTrigs dhoTrigs;
static RhoIdent rhoIdent;
static DhoIdent ident0;
static DhoIdents idents;

static RhoConfigs rhoConfigs;
static DhoConfigs dhoConfigs;
 ...
 * Array Types:
 * ============
 * Array_uint8_23: Array with 23 element(s) of type uint8
 ...
 * Per-Instance Memory:
 * ====================
 *   uint8 *Rte_Pim_PimRhoBackup(void)
 *     Returnvalue: uint8* is of type Array_uint8_23
 *
 * Calibration Parameters:
 * =======================
 *   SW-C local Calibration Parameters:
 *   ----------------------------------
 *   uint8 *Rte_CData_PimRhoBackup_DefaultValue(void)
 *     Returnvalue: uint8* is of type Array_uint8_23
 *
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: DataServices_Data_RHO_Bckup_ConditionCheckRead
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ConditionCheckRead> of PortPrototype <DataServices_Data_RHO_Bckup>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   Std_ReturnType DataServices_Data_RHO_Bckup_ConditionCheckRead(Dcm_OpStatusType OpStatus, Dcm_NegativeResponseCodeType *ErrorCode)
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
 * =============================
 *   RTE_E_DataServices_Data_RHO_Bckup_DCM_E_PENDING
 *   RTE_E_DataServices_Data_RHO_Bckup_E_NOT_OK
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_RHO_Bckup_ConditionCheckRead_doc
 *********************************************************************************************************************/
...
FUNC(Std_ReturnType, CtApTis_CODE) DataServices_Data_RHO_Bckup_ConditionCheckRead(Dcm_OpStatusType OpStatus, P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, RTE_CTAPTIS_APPL_VAR) ErrorCode) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_RHO_Bckup_ConditionCheckRead (returns application error)
 *********************************************************************************************************************/
	...
	if (ErrorCode != NULL){
		*ErrorCode = DCM_E_POSITIVERESPONSE;
		...
		return RTE_E_DataServices_Data_RHO_Bckup_E_NOT_OK;
	}
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: DataServices_Data_RHO_Bckup_ReadData
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <ReadData> of PortPrototype <DataServices_Data_RHO_Bckup>
 *
 **********************************************************************************************************************
 *
 ...
 *     Argument MI_data0: uint8* is of type Dcm_Data10ByteType
 *     Argument MI_data1: uint8* is of type Dcm_Data10ByteType
 *     Argument MI_data2: uint8* is of type Dcm_Data10ByteType
 *     Argument MI_data3: uint8* is of type Dcm_Data10ByteType
 *     Argument MI_data4: uint8* is of type Dcm_Data1ByteType
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_RHO_Bckup_ReadData_doc
 *********************************************************************************************************************/
...
FUNC(Std_ReturnType, CtApTis_CODE) DataServices_Data_RHO_Bckup_ReadData(Dcm_OpStatusType OpStatus, P2VAR(uint8, AUTOMATIC, RTE_CTAPTIS_APPL_VAR) MI_data0, P2VAR(uint8, AUTOMATIC, RTE_CTAPTIS_APPL_VAR) MI_data1, P2VAR(uint8, AUTOMATIC, RTE_CTAPTIS_APPL_VAR) MI_data2, P2VAR(uint8, AUTOMATIC, RTE_CTAPTIS_APPL_VAR) MI_data3, P2VAR(uint8, AUTOMATIC, RTE_CTAPTIS_APPL_VAR) MI_data4) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_RHO_Bckup_ReadData (returns application error)
 *********************************************************************************************************************/

	MI_data0[0] = (uint8)(ident0.mh >> 24);
	MI_data0[1] = (uint8)(ident0.mh >> 16);
	MI_data0[2] = (uint8)(ident0.mh >> 8);
	MI_data0[3] = (uint8)(ident0.mh);

	MI_data0[4] = (uint8)(ident0.mt >> 8);
	MI_data0[5] = (uint8)(ident0.mt);

	MI_data0[6] = (uint8)(ident0.mn >> 24);
	MI_data0[7] = (uint8)(ident0.mn >> 16);
	MI_data0[8] = (uint8)(ident0.mn >> 8);
	MI_data0[9] = (uint8)(ident0.mn);

	MI_data1[0] = (uint8)(idents.Ident1.mh >> 24);
	MI_data1[1] = (uint8)(idents.Ident1.mh >> 16);
	MI_data1[2] = (uint8)(idents.Ident1.mh >> 8);
	MI_data1[3] = (uint8)(idents.Ident1.mh);

	MI_data1[4] = (uint8)(idents.Ident1.mt >> 8);
	MI_data1[5] = (uint8)(idents.Ident1.mt);

	MI_data1[6] = (uint8)(idents.Ident1.mn >> 24);
	MI_data1[7] = (uint8)(idents.Ident1.mn >> 16);
	MI_data1[8] = (uint8)(idents.Ident1.mn >> 8);
	MI_data1[9] = (uint8)(idents.Ident1.mn);

	MI_data2[0] = (uint8)(idents.Ident2.mh >> 24);
	MI_data2[1] = (uint8)(idents.Ident2.mh >> 16);
	MI_data2[2] = (uint8)(idents.Ident2.mh >> 8);
	MI_data2[3] = (uint8)(idents.Ident2.mh);

	MI_data2[4] = (uint8)(idents.Ident2.mt >> 8);
	MI_data2[5] = (uint8)(idents.Ident2.mt);

	MI_data2[6] = (uint8)(idents.Ident2.mn >> 24);
	MI_data2[7] = (uint8)(idents.Ident2.mn >> 16);
	MI_data2[8] = (uint8)(idents.Ident2.mn >> 8);
	MI_data2[9] = (uint8)(idents.Ident2.mn);

	MI_data3[0] = (uint8)(rhoIdent.ident.mh >> 24);
	MI_data3[1] = (uint8)(rhoIdent.ident.mh >> 16);
	MI_data3[2] = (uint8)(rhoIdent.ident.mh >> 8);
	MI_data3[3] = (uint8)(rhoIdent.ident.mh);

	MI_data3[4] = (uint8)(rhoIdent.ident.mt >> 8);
	MI_data3[5] = (uint8)(rhoIdent.ident.mt);

	MI_data3[6] = (uint8)(rhoIdent.ident.mn >> 24);
	MI_data3[7] = (uint8)(rhoIdent.ident.mn >> 16);
	MI_data3[8] = (uint8)(rhoIdent.ident.mn >> 8);
	MI_data3[9] = (uint8)(rhoIdent.ident.mn);

	MI_data4[0] = (uint8)(rhoIdent.ecuName);
    return RTE_E_OK;
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: DataServices_Data_RHO_Ctrl_WriteData
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <WriteData> of PortPrototype <DataServices_Data_RHO_Ctrl>
 *
 **********************************************************************************************************************
 *
 * Exclusive Area Access:
 ...
 * Runnable prototype:
 * ===================
 *   Std_ReturnType DataServices_Data_RHO_Ctrl_WriteData(const uint8 *Data, Dcm_OpStatusType OpStatus, Dcm_NegativeResponseCodeType *ErrorCode)
 ...
 * Available Application Errors:
 * =============================
 *   RTE_E_DataServices_Data_RHO_Ctrl_DCM_E_PENDING
 *   RTE_E_DataServices_Data_RHO_Ctrl_E_NOT_OK
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_RHO_Ctrl_WriteData_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: DataServices_Data_RHO_Ctrl_WriteData (returns application error)
 *********************************************************************************************************************/

	if (*Data == RhoCtrlVal_Confirm) RhoCtrl_Confirm(&rhoTrigs, &ident0, &idents, &rhoIdent);
	if (*Data == RhoCtrlVal_Restore) RhoCtrl_Restore(&rhoTrigs, &ident0, &rhoIdent);
	if (*Data == RhoCtrlVal_OvrwEnbld){
		dhoConfigs.OvrwEnbldCfg=TRUE;
		rhoConfigs.OvrwEnbldCfg=TRUE;
	}
	if (*Data == RhoCtrlVal_Reset0){
		dhoTrigs.Reset1Trig=FALSE;
		dhoTrigs.Reset2Trig=FALSE;
		ident0.mn = 0;
		ident0.mt = 0;
		ident0.mh = 0;
		dhoTrigs.MnTrig=TRUE;
	}
	if (*Data == RhoCtrlVal_Reset1){
		dhoTrigs.Reset2Trig=FALSE;
		dhoTrigs.Reset1Trig=TRUE;
		dhoTrigs.DiagTrig = TRUE;
	}
	if (*Data == RhoCtrlVal_Reset2){
		dhoTrigs.Reset1Trig=FALSE;
		dhoTrigs.Reset2Trig=TRUE;
		dhoTrigs.DiagTrig = TRUE;
	}
	return E_OK;
...
FUNC(void, CtApTis_CODE) RCtApTis_Init(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
	...
	*********************************************************************************************************************/
	...
	dhoTrigs = (DhoTrigs){FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE};
	rhoIdent = (RhoIdent) { (DhoIdent) { 0xFFFF, 0xFFFFFFFF, 0xFFFFFFFF }, (EcuName) {EcuNA} };
	rhoIdent.ident.mh = (  ( *RtePim_PimRhoBackup() )[0] << 24  ) + (  ( *RtePim_PimRhoBackup() )[1] << 16  ) + (  ( *RtePim_PimRhoBackup() )[2] << 8  ) + (  ( *RtePim_PimRhoBackup() )[3]  );
	rhoIdent.ident.mt = (  ( *RtePim_PimRhoBackup() )[4] << 8   ) + (  ( *RtePim_PimRhoBackup() )[5] );
	rhoIdent.ident.mn = (  ( *RtePim_PimRhoBackup() )[6] << 24  ) + (  ( *RtePim_PimRhoBackup() )[7] << 16  ) + (  ( *RtePim_PimRhoBackup() )[8] << 8  ) + (  ( *RtePim_PimRhoBackup() )[9]  );
	rhoIdent.ecuName =     ( *RtePim_PimRhoBackup() )[10];
	
	dhoConfigs.DiagTrigCfg = TRUE;
	dhoConfigs.ParamCheckCfg = FALSE;
	dhoConfigs.OvrwEnbldCfg = FALSE;
	rhoConfigs.OvrwEnbldCfg = FALSE;

	DhoInit_Vbm(dhoConfigs);
	RhoInit(rhoConfigs);
	rhoTrigs = (RhoTrigs){ FALSE, FALSE };
	...
	*********************************************************************************************************************/
	...
	if ((Rte_ActivatingEvent_RCtApTis_RxEvents_ActReason_VbmId & activationVector) != 0)
	{
		...
		if (E_OK == returnType) {
			...
			RhoCheckUniqueId(dhoTrigs, ident0, idents);
		}
	}
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_NvMService_AC3_SRBS_Defs_RhoBackup_GetErrorStatus(NvM_RequestResultType *ErrorStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_RhoBackup_E_NOT_OK
 *   Std_ReturnType Rte_Call_NvMService_AC3_SRBS_Defs_RhoBackup_RestoreBlockDefaults(dtRef_VOID DstPtr)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_RhoBackup_E_NOT_OK
 *   Std_ReturnType Rte_Call_NvMService_AC3_SRBS_Defs_RhoBackup_WriteBlock(dtRef_const_VOID SrcPtr)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_RhoBackup_E_NOT_OK
 *
 * Exclusive Area Access:
...
FUNC(void, CtApTis_CODE) RCtApTis_Step100ms(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 ...
 *********************************************************************************************************************/
	...
	if ((EemStates.OverallEemState != EemState_ReadyToStartEngine) &&
		...
		if (EemState_ReadyToStartEngine == EemStates.OverallEemState){
			...
			if (dhoTrigs.changeIdTrig){
				rhoIdent.ecuName=getEcuName();
				rhoIdent.ident.mh=getMh_repair();
				rhoIdent.ident.mt=getMt_repair();
				rhoIdent.ident.mn=getMn_repair();
				RhoCallChangeId(&rhoTrigs, rhoIdent);
				dhoTrigs.changeIdTrig=FALSE;
			}
		}
		if (dhoTrigs.TxTrig){
			sTotalVehicleHours TotalVehicleHours;
			...
			if (E_OK == fct_status) dhoTrigs.TxTrig = FALSE;
		}
		if ( rhoTrigs.MnthTrig){
			Std_ReturnType fct_status3 = Rte_Call_PpMachineCounter_SetMachineCounter(ident0.mh);
			...
			if (fct_status1 == RTE_E_OK && fct_status2 == RTE_E_OK && fct_status3 == RTE_E_OK){
				rhoTrigs.MnthTrig = FALSE;
			}
			dhoTrigs.DiagTrig = TRUE;
		}
		if (dhoTrigs.MhTrig){
			Std_ReturnType fct_status = Rte_Call_PpMachineCounter_SetMachineCounter(ident0.mh);
			if (E_OK == fct_status) dhoTrigs.MhTrig = FALSE;
		}
		if (dhoTrigs.MnTrig){// changer la configuration si "Synchronisation by Ecu1 and Ecu2" ou si "Restore"
			Dcm_NegativeResponseCodeType Call_DataServices_Data_Config_MachineNumber_Read_WriteData_ErrorCode = 0U;
			Dcm_NegativeResponseCodeType Call_DataServices_Data_Config_Machinetype_Read_WriteData_ErrorCode = 0U;
			Dcm_Data4ByteType Call_DataServices_Data_Config_MachineNumber_Read_WriteData_Data = { 0U, 0U, 0U, 0U };
			Dcm_Data2ByteType Call_DataServices_Data_Config_Machinetype_Read_WriteData_Data = { 0U, 0U };
			...
			if (fct_status1 == RTE_E_OK && fct_status2 == RTE_E_OK){
				dhoTrigs.MnTrig = FALSE;
			}
		}
	}

	if (0 == (compteurStepTis100ms %PERIOD_MSGID100ms_5s)){
		SG_CmaTis data;
		if (!dhoTrigs.Reset1Trig && !dhoTrigs.Reset2Trig){
			data.ConfigMachineNumber = ident0.mn;
			if (rhoTrigs.MnthOvrWrttnTrig){
				data.ConfigMachineType = 0xFEFF;
			}
			else{
				data.ConfigMachineType = ident0.mt;
			}
		}
		else if (dhoTrigs.Reset1Trig){
			data.ConfigMachineNumber=0xFFFFFFFE;
			data.ConfigMachineType=0xFFFE;
		}
		else if (dhoTrigs.Reset2Trig){
			data.ConfigMachineNumber=0xFFFFFFFD;
			data.ConfigMachineType=0xFFFD;
		}
		Rte_Write_PpOutVbmIdCANmsg_DeEcuTis(&data);
	}
	if (0 == (compteurStepTis100ms %PERIOD_MSGID100ms_6s)){// to receive MI not synchronised from other Ecus
		dhoTrigs.SyncAllwd = TRUE;
	}
