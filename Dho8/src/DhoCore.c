...
void Call50msDho(EcuStruct* ecuAddr,Trigs* rxTrigsAddr,IdentVbm* ident0Addr, Idents idents){
	ecuAddr->cc_50ms++;
...
void Call50msDho_Diag(EcuStruct* ecuAddr,Trigs* rxTrigsAddr,IdentVbm* ident0Addr, Idents idents){
	ecuAddr->cc_50ms++;
	if (ecuAddr->per_50ms != 0 && ecuAddr->cc_50ms % ecuAddr->per_50ms == 0) {
		rxTrigsAddr->TxTrig=true;
	}
...
void Call50msDho_Vbm(Trigs* rxTrigsAddr,IdentVbm* ident0Addr, Idents idents){
	Call50msDho(&ecuVbm,rxTrigsAddr,ident0Addr,idents);
}
void Call50msDho_Fum(Trigs* rxTrigsAddr,IdentVbm* ident0Addr, Idents idents){
	Call50msDho(&ecuFum,rxTrigsAddr,ident0Addr,idents);
}
void Call50msDho_Lim(Trigs* rxTrigsAddr,IdentVbm* ident0Addr, Idents idents){
	Call50msDho(&ecuLim,rxTrigsAddr,ident0Addr,idents);
}

void Call50msDho_Vbm_Diag(Trigs* rxTrigsAddr,IdentVbm* ident0Addr, Idents idents){
	Call50msDho_Diag(&ecuVbm,rxTrigsAddr,ident0Addr,idents);
}
void Call50msDho_Fum_Diag(Trigs* rxTrigsAddr,IdentVbm* ident0Addr, Idents idents){
	Call50msDho_Diag(&ecuFum,rxTrigsAddr,ident0Addr,idents);
}
void Call50msDho_Lim_Diag(Trigs* rxTrigsAddr,IdentVbm* ident0Addr, Idents idents){
