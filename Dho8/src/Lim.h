...
extern void Call50msDho_Lim(Trigs* rxTrigs,IdentVbm* ident0Addr, Idents idents);
extern void Call50msDho_Lim_Diag(Trigs* rxTrigs,IdentVbm* ident0Addr, Idents idents);
